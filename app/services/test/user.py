...
def create_admin_user(mock_session):
    user_create = UserCreate(
        username="adminuser",
        password="password123",
...
def get_by_username(mock_session):
    username = "testuser"
...
def get_by_username_not_found(mock_session):
    username = "unknown"
